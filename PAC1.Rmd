...
![](images/clipboard-3636223962.png)
...
![](images/clipboard-3557996507.png)

![](images/clipboard-2127165342.png)

Esto nos creará el repositorio, el enlace del cual deberemos copiar en RStudio:

![](images/clipboard-3940631010.png)
...
#normalization <- normalizeBetweenArrays(assay(summarized_experiment))
#assay(summarized_experiment) <- normalization
